...
add constraint fk_nhan_vien_vi_tri foreign key (ma_vi_tri) references vi_tri (ma_vi_tri),
add constraint fk_nhan_vien_trinh_do foreign key (ma_trinh_do) references trinh_do (ma_trinh_do),
add constraint fk_nhan_vien_bo_phan foreign key (ma_bo_phan) references bo_phan (ma_bo_phan);

alter table khach_hang
add constraint fk_khach_hang_loai_khach foreign key (ma_loai_khach) references loai_khach (ma_loai_khach);

alter table dich_vu
add constraint fk_dich_vu_kieu_thue foreign key (ma_kieu_thue) references kieu_thue (ma_kieu_thue),
add constraint fk_dich_vu_loai_dich_vu foreign key (ma_loai_dich_vu) references loai_dich_vu (ma_loai_dich_vu);

alter table hop_dong
add constraint fk_hop_dong_nhan_vien foreign key (ma_nhan_vien) references nhan_vien (ma_nhan_vien),
add constraint fk_hop_dong_khach_hang foreign key (ma_khach_hang) references khach_hang (ma_khach_hang),
add constraint fk_hop_dong_dich_vu foreign key (ma_dich_vu) references dich_vu (ma_dich_vu);

alter table hop_dong_chi_tiet
add constraint fk_hop_dong_chi_tiet_hop_dong foreign key (ma_hop_dong) references hop_dong (ma_hop_dong),
add constraint fk_hop_dong_chi_tiet_dich_vu_di_kem foreign key (ma_dich_vu_di_kem) references dich_vu_di_kem (ma_dich_vu_di_kem);
